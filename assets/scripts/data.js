		...
		preguntas:[
			{
				...
				retroalimentacionko:'No es correcto. Sus síntomas (dolor torácico, brazo izquierdo, presión alta) corresponden a una Enfermedad Cardiocerebrovasvascular (ECV).'
			},{
				...
				correcta:3,
				retroalimentacionok:'¡Bien! El tabaquismo y el sedentarismo son factores MODIFICABLES — los más relevantes porque están directamente relacionados con el estilo de vida.',
				...
				correcta:3,
				retroalimentacionok:'¡Exacto! Las ECV incluyen infarto de miocardio, ACV, enfermedades coronarias, arteriales periféricas e hipertensión. Son crónicas: requieren seguimiento continuo.',
		...
		preguntas:[
			{
				...
				correcta:2,
				retroalimentacionok:'¡Exacto! El cáncer es una enfermedad en la que algunas células del cuerpo crecen de manera descontrolada y pueden diseminarse a otras partes. Incluye pulmón, mama, cuello uterino, colon y recto, entre otros.',
				...
				correcta:3,
				retroalimentacionok:'¡Bien! Tabaquismo y alcohol son factores MODIFICABLES y comportamentales - los más relevantes porque dependen del estilo de vida y pueden cambiarse.',
		...
		preguntas:[
			{
				...
				correcta:2,
				retroalimentacionok:'¡Perfecto! Las enfermedades respiratorias crónicas incluyen el asma y la EPOC (Enfermedad Pulmonar Obstructiva Crónica).',
